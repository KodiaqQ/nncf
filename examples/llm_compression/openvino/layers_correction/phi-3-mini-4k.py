...
if __name__ == "__main__":
    ...
    configurations = [
        {
            "name": "Only input RMS blocks, rmsnorm",
            "fast_correction": True,
            "correction_type": "rmsnorm",
            "subset_size": 500,
            "ignore_skip_connection": True,
            "data": {
                "task": "gsm8k",
                "dataset_name": "main",
                "data_name": "question",
        ...
        {
            "name": "Only input RMS blocks, pca",
            "fast_correction": True,
            "correction_type": "pca",
            "subset_size": 500,
            "ignore_skip_connection": True,
        ...
        {
            "name": "Only input RMS blocks, lstsq",
            "fast_correction": True,
        ...
        {
            "name": "Input and output RMS blocks, rmsnorm",
            "fast_correction": True,
            "correction_type": "rmsnorm",
            "subset_size": 500,
            "ignore_skip_connection": True,
            ...
            "layers_to_correct": [
                "__module.model.embed_tokens/aten::embedding/Gather",
                "__module.model.layers.\d+/aten::add/Add",
                "__module.model.layers.\d+/aten::add/Add_1",
            ],
        },
        {
            "name": "Input and output RMS blocks, pca",
            "fast_correction": True,
            "correction_type": "pca",
            "subset_size": 500,
            "ignore_skip_connection": True,
        ...
        {
            "name": "Input and output RMS blocks, lstsq",
            "fast_correction": True,
            "correction_type": "lstsq",
            "subset_size": 500,
            "ignore_skip_connection": True,
        ...
        },
        {
            ...
            "layers_to_correct": [
                "__module.model.layers.\d+.post_attention_layernorm/aten::mul/Multiply_1",
            ],
        },
        {
